...
const styles = {
  ...
  headerNavigationAddressLogout:
    'header-navigation-address-logout text-tertiary cursor-pointer relative z-1 transition-all duration-200 ease-out hover:text-accent'
