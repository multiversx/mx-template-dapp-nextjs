...
// Ensure local .env files (e.g., .env.test.local) are loaded when running locally.
loadLocalEnv('test');
...
export enum OriginPageEnum {
  ...
  templateHome = 'https://localhost:3000',
  templateDashboard = 'https://localhost:3000/dashboard',
  templateUnlock = 'https://localhost:3000/unlock'
}
...
export enum SelectorsEnum {
  ...
  pemButton = 'pemBtn',
  pingButton = 'btnPingRaw',
  pongButton = 'btnPongRaw',
